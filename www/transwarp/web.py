...
class RedirectError(HttpError):
        ...
        >>> e = RedirectError(302, 'http://baidu.com/')
        >>> e.status
        '302 Found'
        >>> e.location
        'http://baidu.com/'
...
def redirect(location):
        ...
        >>> raise redirect('http://www.baidu.com/')
        Traceback (most recent call last):
        	...
        RedirectError: 301 Moved Permanently, http://www.baidu.com/
        '''
...
def found(location):
        ...
        >>> raise found('http://www.baidu.com/')
        Traceback (most recent call last):
        	...
        RedirectError: 302 Found, http://www.baidu.com/
        '''
...
def seeother(location):
        ...
        >>> raise seeother('http://baidu.com/')
        Traceback (most recent call last):
        	...
        RedirectError: 303 See Other, http://baidu.com/
        >>> e = seeother('http://baidu.com/')
        >>> e.location
        'http://baidu.com/'
        '''
...
class Request(object):
        ...
        def __getitem__(self, key):
                '''
                Get raw input as dict containing values as unicode, list or Multipart value, the first one is returned.
                ...
                if not hasattr(self, '_headers'):
                        ...
                        for k, v in self._environ.iteritems():
                                if k.startswith('HTTP_'):
                                        # convert 'HTTP_ACCEPT_ENCONDING' to 'ACCEPT-ENCODING'
...
class Response(object):
	...
	def content_length(self):
        ...
        def set_cookie(self, name, value, max_age=None, expires=None, path='/', domain=None, secure=False, http_only=True):
                ...
                >>> r._cookies
                {'company': 'company=Example%3D%22Limited%22; Expires=Sat, 14-14-2012 14:06:34 GMT; Path=/sub/; HttpOnly'}
		...
		{'company': 'company=Expires; Expires=Sat, 14-Jul-2012 14:06:34 GMT; Path=/; HttpOnly'}
                ...
                if expires is not None:
                        if isinstance(expires, (float, int, long)):
                                L.append('Expires=%s' % datetime.datetime.fromtimestamp(expires, UTC_0).strftime('%a, %d-%d-%Y %H:%M:%S GMT'))
...
def _build_pattern_fn(pattern):
        ...
        if m:
                return lambda p: p.endswitch(m.group(1))
